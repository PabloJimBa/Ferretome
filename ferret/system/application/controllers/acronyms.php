...
// 		$fields['literature_tracingData'] = 0;
	...
	function confirm(){
		...
		document.location='index.php?c=acronyms&m=del_lit&id=$id';}
	...
	function del_lit(){
		...
		if (!empty($id)){
			...
			$this->db->delete('brain_site_acronyms',array('brain_site_acronyms_id'=>$id));
				
			echo "Deleted. Please, reload the page.";

			echo "<script>document.location='index.php?c=acronyms&m=show'</script>;";
