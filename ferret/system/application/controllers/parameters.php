...
//				$this->data['extraHeader'] = '<script type="text/javascript" src="js/parameters.js"></script>';
	...
	function confirm(){
		...
		document.location='index.php?c=parameters&m=del_lit&id=$id';}
	...
	function del_lit(){
		...
		if (!empty($id)){
			...
			$this->db->delete('parameters',array('parameters_id'=>$id));
				
			echo "Deleted. Please, reload the page.";

			echo "<script>document.location='index.php?c=parameters&m=show'</script>;";
