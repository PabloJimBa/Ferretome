...
<?php foreach($fields_data as $field => $val): ?>
	<tr>
			...
			<?php if($val['type']=='string'):?>
				...
				<input class="input" id="<?php echo $f; ?>" name="<?php echo $f; ?>" value="<?php echo form_prep($output_data->$f); ?>" size="30" />
				
			<?php endif;?>
			
			<?php if($val['type']=='text'):?>

				<textarea class="textarea" id="<?php echo $f; ?>" name="<?php echo $f; ?>" cols="30" rows="10" ><?php echo form_prep($output_data->$f); ?></textarea>
