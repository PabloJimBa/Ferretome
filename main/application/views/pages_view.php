...
<tr>
<td style='background-color:#040E7A;color:white'>Name</td><td style='background-color:#040E7A;color:white'>Type</td><td style='background-color:#040E7A;color:white'>Link</td><td style='background-color:#040E7A;color:white'>Actions</td>
</tr>
...
<tr>
	...
	<td><a href="index.php?c=pages&p=<?=$bdata->page_name?>">preview</a> &nbsp; | &nbsp; <a href="index.php?c=pages&m=edit&id=<?=$bdata->page_id?>">edit</a></td>
</tr>
<?php endforeach; ?>
</table>
